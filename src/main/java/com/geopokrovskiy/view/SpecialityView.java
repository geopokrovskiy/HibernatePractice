    ...
    public void start() {
        ...
        while (true) {
            ...
            if (specOption == 1) {
                ...
                specialityService.addNewSpec(new Speciality(specName));
                break;
                ...
                specialityService.updateSpecName(oldSpec.getId(), newSpec);
                break;
                ...
                if(!specialityService.deleteSpecById(toDelete.getId())){
